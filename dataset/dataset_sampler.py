...
if __name__ == '__main__':
    ...
    if args.task == "dataset_generation_1":
        ...
        sampler = final_sampling(rebalance=[0.75, 0.15, 0.1], path_jsons=args.path_labeled,
        ...
        SAM_segment_creator = SAM_annotations(path_coco_annotations=args.annotations, path_images=args.video_path,
